...
def take_screenshot(index=1):
    ...
    ss_dir = script_dir / "ss"
    ss_dir.mkdir(exist_ok=True)
    filename = ss_dir / "screen.png"
    filename2 = ss_dir / "screen_p.jpg"

    local_path = filename
    local_path2 = filename2
    ...
    return elements, local_path, (width, height)

def get_screen(index=1):
    elements, image_path, (width, height) = take_screenshot(index)
    processed_image = overlay_grid_with_anchors(
    ...
    return elements, processed_image, (width, height) 
